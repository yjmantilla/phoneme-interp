...
VARIANT = "tiny"  # Change this to "base" or "large" as needed
output_dir = "output"
...
df_probes.to_pickle(f"{output_dir}/{VARIANT}/phoneme_probes.pkl")
...
plt.ylim(0, 1)
plt.title("Linear Probe Accuracy per Block (Whisper Tiny)")
